...
This repository contains the Reporting OpenMRS Open Web App.
...
This will create a file called `reporting.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/mseaton/openmrs/refapp/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/home/mseaton/openmrs/refapp/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/home/mseaton/openmrs/refapp/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/reporting/index.html"
}
```
